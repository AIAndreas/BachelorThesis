...
def main():
    ...
    num_dummy = 1
    Iteration = 300
    target_experiments = 100  # Target number of successful experiments
    ...
    attempts = 0  # Track how many total attempts were made

    ''' train DLG and iDLG '''
    while successful_experiments < target_experiments:
        attempts += 1
        try:
            net = LeNet(channel=channel, hideen=hidden, num_classes=num_classes)
            net.apply(weights_init)

            print(f'Attempt {attempts}: Running {successful_experiments + 1}|{target_experiments} experiment')
            net = net.to(device)
            ...
            for method in ['DLG', 'iDLG']:
                ...
                for iters in range(Iteration):
                    ...
                    if current_loss < 0.000001:  # convergence condition
                        break
            ...
            successful_experiments += 1  # Increment counter only if experiment succeeds
