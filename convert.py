...
with open('Output_error/output_lfw_exp1000.txt', 'rb') as file:
    raw_data = file.read()
...
with open('Output_error/output_lfw_exp1000.txt', 'r', encoding=current_encoding) as file:
    content = file.read()

# Step 3: Write the content to a new file in UTF-8 encoding
with open('output_lfw_exp1000_utf8.txt', 'w', encoding='utf-8') as file:
    file.write(content)
